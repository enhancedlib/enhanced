...
#include "enhanced/basic/container/mixed/MixedDeque.h"
...
#pragma warning(disable: 4584)
    ...
    class MixedLinkedList final : public Collection<Type>, public MixedDeque<Type>, public MixedList<Type>,
                                  private enhanced::basic::generic_impl::container::mixed::MixedLinkedListImpl {
#pragma warning(pop)
#else
    template <typename Type>
    class MixedLinkedList final : public MixedList<Type>, public MixedDeque<Type>, private enhanced::basic::generic_impl::container::mixed::MixedLinkedListImpl {
#endif // COMPILER_MSVC
    private:
        using MixedLinkedListImpl = enhanced::basic::generic_impl::container::mixed::MixedLinkedListImpl;
