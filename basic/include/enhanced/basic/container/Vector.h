...
namespace enhanced::basic::container {
    ...
    class Vector final : public List<Type>, public RandomAccess, private enhanced::basic::generic_impl::container::VectorImpl {
    private:
        using VectorImpl = enhanced::basic::generic_impl::container::VectorImpl;
        ...
        static void setElement(void* elements, Size index, GenericReference value) {
            memoryCopy(((Type*) elements) + index, &value, sizeof(Type));
        }
    ...
    public:
        inline Vector() : VectorImpl(ContainerConfig::ARRAY_INIT_SIZE, {allocateArray, copyArray, moveArray, index, getElement, setElement, equals}) {}
