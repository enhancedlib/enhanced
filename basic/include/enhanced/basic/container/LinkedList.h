...
#pragma warning(disable: 4584)
    ...
    class LinkedList final : public Collection<Type>, public List<Type>, public Deque<Type>,
                             public enhanced::basic::generic_impl::container::LinkedListImpl {
#pragma warning(pop)
#else
    template <typename Type>
    class LinkedList : public List<Type>, public Deque<Type>,
                       private enhanced::basic::generic_impl::container::LinkedListImpl {
#endif // COMPILER_MSVC
    private:
        using LinkedListImpl = enhanced::basic::generic_impl::container::LinkedListImpl;
