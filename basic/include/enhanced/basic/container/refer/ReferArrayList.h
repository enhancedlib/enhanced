...
namespace enhanced::basic::container::refer {
    ...
    class ReferArrayList final : public ReferList<Type>, public RandomAccess,
                                 private enhanced::basic::generic_impl::container::refer::ReferArrayListImpl {
    private:
        using ReferArrayListImpl = enhanced::basic::generic_impl::container::refer::ReferArrayListImpl;
    ...
    public:
        inline ReferArrayList() : ReferArrayListImpl(ContainerConfig::ARRAY_INIT_SIZE, {equals}) {};
