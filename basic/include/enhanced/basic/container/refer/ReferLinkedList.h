...
#include "enhanced/basic/container/refer/ReferList.h"
#include "enhanced/basic/container/refer/ReferDeque.h"

#ifdef CXX_LANGUAGE

namespace enhanced::basic::generic_impl::container::refer {
...
namespace enhanced::basic::container::refer {
/*
...
#pragma warning(disable: 4584)
    ...
    class ReferLinkedList final : public Collection<Type>, public ReferList<Type>, public ReferDeque<Type>,
        private enhanced::basic::generic_impl::container::refer::ReferLinkedListImpl {
    #pragma warning(pop)
#else
    template <typename Type>
    class ReferLinkedList final : public ReferList<Type>, public ReferDeque<Type>, private enhanced::basic::generic_impl::container::refer::ReferLinkedListImpl {
#endif // COMPILER_MSVC
    private:
        using ReferLinkedListImpl = enhanced::basic::generic_impl::container::refer::ReferLinkedListImpl;
