...
using EnhancedContainer::Collection::Referenced::ReferencedLinkedList0;
...
ReferencedLinkedList0::ReferencedLinkedListIterator0::~ReferencedLinkedListIterator0() noexcept {}
...
ReferencedLinkedList0::ReferencedLinkedList0(const ElementOperator elementOperator) :
...
$RetNotIgnored()
bool ReferencedLinkedList0::contain0(const void *const element) const {
