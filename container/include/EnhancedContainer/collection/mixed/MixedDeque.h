...
#ifndef ENHANCED_CONTAINER_COLLECTION_MIXED_MIXED0DEQUE_H
#define ENHANCED_CONTAINER_COLLECTION_MIXED_MIXED0DEQUE_H
...
#include "EnhancedContainer/collection/mixed/MixedQueue.h"
...
namespace EnhancedContainer {
    namespace Collection {
        ...
        #pragma warning(disable: 4584)
            ...
            interface MixedDeque : public Collection<Type>, public Queue<Type>,
                                   public Deque<Type>, public MixedQueue<Type> {
        #else
            template <typename Type>
            interface MixedDeque : public Deque<Type>, public MixedQueue<Type> {
        #endif // COMPILER_MSVC
...
#endif // !ENHANCED_CONTAINER_COLLECTION_MIXED_MIXED0DEQUE_H
