...
#ifndef ENHANCED_CONTAINER_COLLECTION_REFERENCE_REFERENCE0LINKED0LIST_H
#define ENHANCED_CONTAINER_COLLECTION_REFERENCE_REFERENCE0LINKED0LIST_H
...
#include "EnhancedContainer/collection/referenced/ReferencedDeque.h"
...
namespace EnhancedContainer {
    namespace Collection {
        namespace Referenced {
             ...
             */
            class ENHANCED_CONTAINER_API ReferencedLinkedList0 {
            private:
                struct Node {
                    void *value;
            ...
            protected:
                ...
                class ENHANCED_CONTAINER_API ReferencedLinkedListIterator0 {
                private:
                ...
                explicit ReferencedLinkedList0(ElementOperator elementOperator);
        ...
        #pragma warning(pop)
        ...
        #endif // COMPILER_MSVC
            private:
                class ReferencedLinkedListIterator : public Iterator<Type>, private ReferencedLinkedListIterator0 {
            ...
            public:
                inline ReferencedLinkedList() : ReferencedLinkedList0({elementEqual}) {}
                ...
                inline bool contain(const Type &element) const override {
                    return ReferencedLinkedList0::contain0(&element);
                }
                ...
                inline Iterator<Type> *iterator() const override {
                    return static_cast<ReferencedLinkedListIterator *>(
...
#endif // !ENHANCED_CONTAINER_COLLECTION_REFERENCE_REFERENCE0LINKED0LIST_H
